...
# Настройки ежедневного дайджеста (все опциональны — без DIGEST_CHAT_ID
# автоматическая рассылка просто не включится, но команда /digest всё
# равно будет работать вручную в любом чате)
DIGEST_CHAT_ID = os.environ.get("DIGEST_CHAT_ID")
